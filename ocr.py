...
def extract_text():
        ...
        extracted_text = text_box.get("1.0", "end-1c")

        # Open extract.py using subprocess and pass the extracted text as argument
        subprocess.Popen(["python", "extract.py", extracted_text])
...
# Add a non-working button labeled "Extract"
extract_button = ttk.Button(window, text="Extract", style="Custom.TButton", command=extract_text)
